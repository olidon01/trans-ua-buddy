export const translations = {
  uk: {
    ...
    loginTabMagic: "✉ Посилання на пошту",
    loginTabPassword: "🔒 Пароль",
    loginPassword: "Пароль",
    loginRememberMe: "Запам'ятати мене",
    ...
    firstTimeHint: "Перший раз? Натисніть «Забули пароль?» щоб створити пароль.",
    or: "АБО",
    tgHintOpen: "Щоб отримувати повідомлення —",
    tgHintOpenBot: "відкрийте бота",
    tgHintStart: "та натисніть /start.",
    tgWarnNotConnected: "Telegram ще не підʼєднано. Перейдіть до",
    tgWarnBot: "бота",
    tgWarnStart: "та натисніть /start, щоб отримувати повідомлення.",
    tgWarnNoUsername: "Telegram ще не підʼєднано. Ви не отримаєте повідомлення, поки не натиснете /start у боті.",
  ...
  pl: {
    ...
    loginTabMagic: "✉ Link na email",
    loginTabPassword: "🔒 Hasło",
    loginPassword: "Hasło",
    ...
    firstTimeHint: "Pierwszy raz? Kliknij «Zapomniałeś hasła?» aby ustawić hasło.",
    or: "LUB",
    tgHintOpen: "Aby otrzymywać powiadomienia —",
    tgHintOpenBot: "otwórz bota",
    tgHintStart: "i naciśnij /start.",
    tgWarnNotConnected: "Telegram nie jest połączony. Przejdź do",
    tgWarnBot: "bota",
    tgWarnStart: "i naciśnij /start, aby otrzymywać powiadomienia.",
    tgWarnNoUsername: "Telegram nie jest połączony. Nie otrzymasz powiadomień, dopóki nie naciśniesz /start u bota.",
